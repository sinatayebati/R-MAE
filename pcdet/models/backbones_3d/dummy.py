...
class Radial_MAE_ra(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # Calculate the Euclidean distance of each voxel from the origin (0,0) in the XY plane
        ...
        # Combine indices from the selected groups and apply range-aware masking
        selected_indices = []
